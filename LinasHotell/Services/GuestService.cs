...
namespace LinasHotell.Services
{
    public class GuestService : IGuestService
    {
        ...
        public async Task DeleteGuestAsync(GuestModel guestToDelete)
        {
            await _guestRepository.DeleteAsync(guestToDelete);
        }

        public async Task<bool> GuestHasBookingsAsync(int guestId)
        {
            return await _guestRepository.HasBookingsAsync(guestId);
        }
    }
}
